...
exports.joinRoom = async (req, res) => {
    try {
        ...
        // Populate attendees
        await room.populate('attendees', 'username email role user_id');
        await room.populate('host', 'username email user_id');
...
exports.getRoom = async (req, res) => {
    try {
        ...
        .populate('host', 'username email phone user_id')
        .populate('attendees', 'username email phone role user_id')
...
exports.getUserRooms = async (req, res) => {
    try {
        ...
        .populate('host', 'username email user_id')
        .populate('attendees', 'username email phone role user_id')
        .sort({ startDate: -1 });
...
exports.inviteByPhone = async (req, res) => {
    try {
        ...
        await room.save();
        await room.populate('attendees', 'username email phone role user_id');
        await room.populate('host', 'username email user_id');
